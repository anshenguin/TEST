        ...
        savebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(newpassword.getText().toString().equals(confpassword.getText().toString()))
                    ...
                    Toast.makeText(ChangePasswordCompanyActivity.this, "Passwords do not match, please try again...", Toast.LENGTH_SHORT).show();
            }
        });
    }
...
//                        Log.d("LOGGINGME1", String.valueOf(db));
                        Toast.makeText(ChangePasswordCompanyActivity.this, "Password Changed Successfully", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                    else{
