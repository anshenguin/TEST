...
/**
 * Created by HP INDIA on 26-Sep-18.
 */

public class SQLiteHandlerCompany extends SQLiteOpenHelper {
    ...
    // Login table name
    private static final String TABLE_USER = "company";
    ...
    public SQLiteHandlerCompany(Context context) {
     ...
     * */
    public void addUser(String name, String CID, String email, String phone, String phonesec, String address, String city) {
